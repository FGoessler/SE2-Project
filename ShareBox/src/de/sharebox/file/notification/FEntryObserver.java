...
public interface FEntryObserver {
	...
	/**
	 * Der übergebene FEntry wurde auf irgendeine Art und Weise geändert oder gelöscht.<br/>
	 * (zB.: Name wurde geändert, Dateiinhalt hat sich geändert, Rechte geändert, ...)
	 *
